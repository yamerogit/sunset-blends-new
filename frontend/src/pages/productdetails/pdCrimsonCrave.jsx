...
const sizeOptions = [
  { label: '50G', value: 50, price: 59 },
  { label: '100G', value: 100, price: 124 }
];

const PdCrimsonCrave = () => {
        ...
        <div className="flex gap-16 items-start" style={{ marginLeft: "120px" }}>
          ...
          <div className="flex-1 max-w-xl">
            ...
            <p className="text-[#322315] text-base mb-6 leading-relaxed" style={{ maxWidth: '600px' }}>
              Vibrant red velvet cookie with a soft, moist texture and subtle cocoa flavor, finished with a sweet cream cheese glaze.
            </p>
