        ...
        <div className="flex gap-16 items-start" style={{ marginLeft: "100px" }}>
          ...
          <div className="flex-1 max-w-xl">
            ...
            <p className="text-[#322315] text-base mb-6 leading-relaxed" style={{ maxWidth: '600px' }}>
              A cool blend of rich coffee, creamy milk, and decadent salted caramel, poured over ice and finished with a hint of sea salt. Sweet, salty, and refreshing!
            </p>
...
export default PdColdSaltedCaramel;
