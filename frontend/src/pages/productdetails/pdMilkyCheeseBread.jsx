...
const quantityOptions = [
  { label: '1 Piece', value: 1, price: 25 },
  { label: '6 Pieces', value: 6, price: 150 },
  { label: '12 Pieces', value: 12, price: 300 }
];
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-16 items-start" style={{ marginLeft: "120px" }}>
          ...
          <div className="flex-shrink-0" style={{ marginLeft: "-20px" }}>
            ...
            >
              <img 
                src={milkyCheeseBread}
                alt="Milky Cheese Bread"
                style={{
                  maxWidth: "280px",
                  maxHeight: "280px",
                  objectFit: "contain"
          ...
          <div className="flex-1 max-w-xl">
            ...
            <p className="text-[#322315] text-base mb-6 leading-relaxed" style={{ maxWidth: '600px' }}>
              Soft, fluffy bread filled with rich, creamy cheese.
            </p>
...
export default PdMilkyCheeseBread;
