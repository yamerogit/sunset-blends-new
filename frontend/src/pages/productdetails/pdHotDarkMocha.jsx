        ...
        <div className="flex gap-16 items-start" style={{ marginLeft: "100px" }}>
          ...
          <div className="flex-1 max-w-xl">
            ...
            <p className="text-[#322315] text-base mb-6 leading-relaxed" style={{ maxWidth: '600px' }}>
              Rich and indulgent dark chocolate blended with premium espresso, 
              topped with steamed milk for the perfect balance of bitter and sweet. 
              A warming treat for chocolate and coffee lovers.
            </p>
