...
// Update the import path to your Cold Spanish Latte image
import coldSpanishLatte from '../../images/Coffee/ColdSpanishLatte.png';

const PdColdSpanishLatte = () => {
  ...
  const handleAddToCart = () => {
    ...
    toast.success(`${quantity} Cold Spanish Latte (${selectedSize}) added to cart!`, {
      duration: 2000,
      position: 'top-center',
      style: {
        background: '#218C8D',
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-16 items-start" style={{ marginLeft: "100px" }}>
          ...
          <div className="flex-shrink-0" style={{ marginLeft: "-20px" }}>
            ...
            >
              <img 
                src={coldSpanishLatte}
                alt="Cold Spanish Latte"
                style={{
                  maxWidth: "280px",
                  maxHeight: "280px",
                  objectFit: "contain"
          ...
          <div className="flex-1 max-w-xl">
            ...
            <p className="text-[#322315] text-base mb-6 leading-relaxed" style={{ maxWidth: '600px' }}>
              Sweet and creamy Spanish Latte over ice, blending espresso, milk, and condensed milk for a refreshing, indulgent coffee experience with every sip.
            </p>
...
export default PdColdSpanishLatte;
