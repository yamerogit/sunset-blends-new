...
// Update the following path to your correct image:
import cinnamonRoll from '../../images/Pastry/CinnamonRoll.png';

const quantityOptions = [
  { label: '1 Piece', value: 1, price: 75 },
  { label: '2 Pieces', value: 2, price: 150 },
  { label: '4 Pieces', value: 4, price: 300 }
];

const PdCinnamonRoll = () => {
        ...
        <div className="flex gap-16 items-start" style={{ marginLeft: "120px" }}>
          ...
          <div className="flex-1 max-w-xl">
            ...
            <p className="text-[#322315] text-base mb-6 leading-relaxed" style={{ maxWidth: '600px' }}>
              Soft, golden roll swirled with cinnamon sugar and topped with sweet vanilla glaze.
            </p>
