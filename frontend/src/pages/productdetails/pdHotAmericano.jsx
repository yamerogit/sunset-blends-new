...
// Update the import below to your actual Americano image
import hotAmericano from '../../images/Coffee/HotAmericano.png';

const PdHotAmericano = () => {
  ...
  const handleAddToCart = () => {
    ...
    toast.success(`${quantity} Hot Americano (${selectedSize}) added to cart!`, {
      duration: 2000,
      position: 'top-center',
      style: {
        background: '#218C8D',
        ...
        <div className="flex gap-16 items-start" style={{ marginLeft: "100px" }}>
            ...
            >
              <img 
                ...
                style={{
                  ...
                  maxHeight: "280px",
                  objectFit: "contain",
                  marginLeft: "-10px" // This moves the image more left
                }}
          ...
          <div className="flex-1 max-w-xl">
            ...
            <p className="text-[#322315] text-base mb-6 leading-relaxed" style={{ maxWidth: '600px' }}>
              Classic and bold espresso diluted with hot water, resulting in a smooth and rich coffee experience. Perfect for those who love pure, strong coffee flavor.
            </p>
