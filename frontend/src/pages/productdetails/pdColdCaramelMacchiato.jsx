...
// Edit the import path to your Cold Caramel Macchiato image:
import coldCaramelMacchiato from '../../images/Coffee/ColdCaramelMacchiato.png';

const PdColdCaramelMacchiato = () => {
  ...
  const handleAddToCart = () => {
    ...
    toast.success(`${quantity} Cold Caramel Macchiato (${selectedSize}) added to cart!`, {
      duration: 2000,
      position: 'top-center',
      style: {
        background: '#218C8D',
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-16 items-start" style={{ marginLeft: "100px" }}>
          ...
          <div className="flex-shrink-0" style={{ marginLeft: "-20px" }}>
            ...
            >
              <img 
                src={coldCaramelMacchiato}
                alt="Cold Caramel Macchiato"
                style={{
                  maxWidth: "280px",
                  maxHeight: "280px",
                  objectFit: "contain"
          ...
          <div className="flex-1 max-w-xl">
            ...
            <p className="text-[#322315] text-base mb-6 leading-relaxed" style={{ maxWidth: '600px' }}>
              Refreshing iced macchiato with bold espresso, velvety milk, and sweet caramel drizzle. Served cold for the perfect balance of creamy, rich, and sweet.
            </p>
...
export default PdColdCaramelMacchiato;
