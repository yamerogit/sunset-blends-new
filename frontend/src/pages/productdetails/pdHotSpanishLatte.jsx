        ...
        <div className="flex gap-16 items-start" style={{ marginLeft: "100px" }}>
          ...
          <div className="flex-1 max-w-xl">
            ...
            <p className="text-[#322315] text-base mb-6 leading-relaxed" style={{ maxWidth: '600px' }}>
              A creamy and sweet latte featuring a shot of espresso with steamed milk and a touch of condensed milk. Deliciously smooth and comforting for any time of day.
            </p>
...
export default PdHotSpanishLatte;
