...
// Update import path to actual image file!
import coldDarkMocha from '../../images/Coffee/ColdDarkMocha.png';

const PdColdDarkMocha = () => {
  ...
  const handleAddToCart = () => {
    const item = {
      id: `cold-dark-mocha-${selectedSize}`,
      name: 'Cold Dark Mocha',
    ...
    toast.success(`${quantity} Cold Dark Mocha (${selectedSize}) added to cart!`, {
      duration: 2000,
      position: 'top-center',
      style: {
        background: '#218C8D',
        ...
        <div className="flex gap-16 items-start" style={{ marginLeft: "100px" }}>
          ...
          <div className="flex-1 max-w-xl">
            ...
            <p className="text-[#322315] text-base mb-6 leading-relaxed" style={{ maxWidth: '600px' }}>
              Indulgent dark chocolate blended with smooth espresso and poured over ice, finished with milk for a refreshing, bittersweet treat. Perfect for cooling down while still getting your chocolate and caffeine fix.
            </p>
...
export default PdColdDarkMocha;
