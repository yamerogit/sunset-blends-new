...
const quantityOptions = [
  { label: '1 Piece', value: 1, price: 35 },
  { label: '6 Pieces', value: 6, price: 200 },
  { label: '12 Pieces', value: 12, price: 400 }
];

const PdChocoBrownie = () => {
        ...
        <div className="flex gap-16 items-start" style={{ marginLeft: "120px" }}>
          ...
          <div className="flex-1 max-w-xl">
            ...
            <p className="text-[#322315] text-base mb-6 leading-relaxed" style={{ maxWidth: '600px' }}>
              Fudgy, rich chocolate brownie with a dense, moist texture and intense cocoa flavor. Perfect for satisfying your chocolate cravings.
            </p>
