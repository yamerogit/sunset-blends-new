...
const sizeOptions = [
  { label: '50G', value: 50, price: 55 },
  { label: '100G', value: 100, price: 115 }
];
        ...
        <div className="flex gap-16 items-start" style={{ marginLeft: "120px" }}>
          ...
          <div className="flex-1 max-w-xl">
            ...
            <p className="text-[#322315] text-base mb-6 leading-relaxed" style={{ maxWidth: '600px' }}>
              Delicate matcha cookie with authentic green tea flavor, offering a perfect balance of earthy sweetness and subtle bitterness.
            </p>
